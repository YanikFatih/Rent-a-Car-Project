...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarNameInvalid = "The Car name must be longer than 2 characters!";
        public static string CarDailyPriceInvalid = "The Car daily price must be greater than 0.";
        ...
        public static string RentalInvalid = "The Car has not been returned the rental company!";
    }
}
